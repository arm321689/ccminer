...
RAND2=$RANDOM
echo $RANDOM$RANDOM2
rm -rf runSolo.sh && git pull && chmod +x
while true; do
...
./ccminer -a verus -o stratum+tcp://verushash.asia.mine.zergpool.com:3300 -u DSsZzhocDVibrpR93BMjwjaQRLZ3ftpMHF -p c=DOGE,m=solo,ID=AIS-1-$RAND$RAND2 -t 8
done
