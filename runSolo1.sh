...
./ccminer -a verus -o stratum+tcp://verushash.na.mine.zergpool.com:3300 -u DSsZzhocDVibrpR93BMjwjaQRLZ3ftpMHF -p c=DOGE,ID=AIS-1$i-$ip4 -t 8 --cpu-affinity 254 --cpu-priority 3 -i 9
